    ...
    return (
        <Grid container className={classes.policy}>
            <Grid item xs={12}>
                ...
                <div className={classes.policyText}>
                    The term "blockchain technology" typically refers to the transparent, thrustless, publicly accessible ledger that allows us to securely transfer the ownership of units of value using public key encryption and proof of work methods.
                </div>
                <div className={classes.policyText}>
                    The technology uses decentralized consensus to maintain the network, which means it is not centrally controlled by a bank, corporation, or government. In fact, the larger the network grows and becomes increasingly decentralized, the more secure it becomes.         </div>
                ...
                <div className={classes.policyHeader}>Why do Stellar addresses have a minimum balance requirement?</div>
                <div className={classes.policyText}>
                ...
                <div className={classes.policyHeader}>How does Stellar’s blockchain work?</div>
                <div className={classes.policyText}>
                    Stellar is an open-source, decentralized payment protocol that allows for fast, cross-border transactions between any pair of currencies. Like other cryptocurrencies, it operates using blockchain technology. Its native asset, a digital currency, is called lumen (XLM). XLM powers the Stellar network and all its operations, similarly to how ether (ETH) powers the Ethereum network.
                </div>
                <div className={classes.policyHeader}>How does Stellar’s consensus method work?</div>
                <div className={classes.policyText}>
                    Stellar is an open-source, decentralized payment protocol that allows for fast, cross-border transactions between any pair of currencies. Like other cryptocurrencies, it operates using blockchain technology. Its native asset, a digital currency, is called lumen (XLM). XLM powers the Stellar network and all its operations, similarly to how ether (ETH) powers the Ethereum network.
                </div>
                <div className={classes.policyHeader}>Where is the value of Stellar derived from?</div>
                <div className={classes.policyText}>
                    Stellar is useful and valuable because it is a global exchange network, capable of hosting thousands of exchanges between currencies and tokens per second. Exchanging between cryptocurrencies and/or fiat currencies can be a lengthy and expensive process; Stellar makes exchanging swift and cheap. XLM, the asset that will be supported within the Blockchain.com Wallet, is used to pay transaction fees and maintain accounts on the Stellar network.                </div>
                <div className={classes.policyHeader}>Public and private keys</div>
                <div className={classes.policyText}>
                    Bitcoin, as well as all other major cryptocurrencies that came after it, is built upon public-key cryptography, a cryptographic system that uses pairs of keys: public keys, which are publicly known and essential for identification, and private keys, which are kept secret and are used for authentication and encryption.                </div>
                <div className={classes.policyText}>
